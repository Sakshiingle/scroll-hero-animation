    ...
    <main ref={container} className="bg-[#121212] overflow-x-hidden select-none">
      <div className="section h-[300vh] relative">
        <div className="track sticky top-0 h-screen w-full flex items-center justify-center bg-[#d1d1d1] overflow-hidden">
          ...
          {/* Bottom Row */}
          <div id="box2" className="text-box opacity-0 scale-90 translate-y-0 absolute bottom-[8%] left-[45%] bg-[#6ac9ff] text-[#111] p-6 rounded-2xl flex flex-col z-20 shadow-xl min-w-62.5">
          ...
          <div id="box4" className="text-box opacity-0 scale-90 translate-y-0 absolute bottom-[8%] right-[8%] bg-[#fa7328] text-[#111] p-6 rounded-2xl flex flex-col z-20 shadow-xl min-w-62.5">
